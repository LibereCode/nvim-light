...
local FzfLua=FzfLua
leadmap('F', function() FzfLua.builtin() end, { desc = "FzfLua builtin"})
leadmap('fb', function() FzfLua.buffers() end, { desc = "buffers"})
leadmap('ff', function() FzfLua.files() end, { desc = "files"})
leadmap('fg', function() FzfLua.live_grep() end, { desc = "live_grep"})

local wk = require('which-key')
leadmap('?', function() wk.show() end, { desc = 'WhichKey[?]' })
wk.add({
